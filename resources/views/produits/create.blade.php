        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('produits.store') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        <label for="quantity" class="col-md-4 col-form-label text-md-end text-start">Quantité</label>
                        <div class="col-md-6">
                    ...
                    <div class="mb-3 row">
                        <label for="price" class="col-md-4 col-form-label text-md-end text-start">Prix</label>
                        <div class="col-md-6">
